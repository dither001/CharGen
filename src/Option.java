...
public interface Option {
	public enum Feature {
		...
		// trickery
		BLESSING_OF_THE_TRICKSTER, INVOKE_DUPLICITY, CLOAK_OF_SHADOWS, DIVINE_STRIKE_TRICKERY, IMPROVED_DUPLICITY,
		// war
		WAR_PRIEST, GUIDED_STRIKE, WAR_GODS_BLESSING, DIVINE_STRIKE_WAR, AVATAR_OF_BATTLE,
		/*
		 * DRUID
		 */
		RITUAL_CASTING_DRUID, WILD_SHAPE_2, WILD_SHAPE_4, WILD_SHAPE_8, TIMELESS_BODY, BEAST_SPELLS, ARCHDRUID,
		// land circle
		 ...
		 * FIGHTER
		 */
		FIGHTING_STYLE, SECOND_WIND, ACTION_SURGE_2, ACTION_SURGE_17, INDOMITABLE_1, INDOMITABLE_2, INDOMITABLE_3,
		// fighting style
		...
		// battle master
		COMBAT_SUPERIORITY, STUDENT_OF_WAR, KNOW_YOUR_ENEMY, RELENTLESS, SUPERIORITY_DICE_4, SUPERIORITY_DICE_5, SUPERIORITY_DICE_6, 
		SUPERIORITY_D8, SUPERIORITY_D10, SUPERIORITY_D12,
		// maneuvers
