...
public interface Option {
	public enum Feature {
		 ...
		 */
		FIGHTING_STYLE, EXTRA_ATTACK_1, LANDS_STRIDE, TIMELESS_BODY,
		/*
		 * BARBARIAN
		 */
		...
		// hunter
		COLOSSUS_SLAYER, GIANT_KILLER, HORDE_BREAKER, ESCAPE_THE_HORDE, MULTIATTACK_DEFENSE, STEEL_WILL, VOLLEY, WHIRLWIND_ATTACK, STAND_AGAINST_THE_TIDE, UNCANNY_DODGE,
		// beast master
