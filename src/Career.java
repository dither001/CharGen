...
public enum Career {
	...
	// villainous schemes
	private static final String[] ALL_SCHEMES = { "IMMORTALITY_1", "IMMORTALITY_2", "IMMORTALITY_3", "IMMORTALITY_4", "INFLUENCE_1", "INFLUENCE_2", "INFLUENCE_3", "INFLUENCE_4", "MAGIC_1", "MAGIC_2", "MAGIC_3", "MAGIC_4", "MAGIC_5", "MAGIC_6", "MAYHEM_1", "MAYHEM_2", "MAYHEM_3", "MAYHEM_4", "MAYHEM_5", "MAYHEM_6", "PASSION_1", "PASSION_2", "PASSION_3", "PASSION_4", "POWER_1", "POWER_2", "POWER_3", "POWER_4", "REVENGE_1", "REVENGE_2", "REVENGE_3", "REVENGE_4", "WEALTH_1", "WEALTH_2", "WEALTH_3", "WEALTH_4" };
	private static final String[] IMMORTALITY_ONLY = { "IMMORTALITY_1", "IMMORTALITY_2", "IMMORTALITY_3", "IMMORTALITY_4" };
	...
	private static final String[] MAYHEM_ONLY = { "MAYHEM_1", "MAYHEM_2", "MAYHEM_3", "MAYHEM_4", "MAYHEM_5", "MAYHEM_6" };
	...
	// villainous methods
	//	private static String[] ALL_METHODS = { "DEVASTATION_1", "DEVASTATION_2", "DEVASTATION_3", "DEVASTATION_4", "METHOD_A", "METHOD_B", "COERCION_1", "COERCION_2", "COERCION_3", "COERCION_4", "COERCION_5", "COERCION_6", "COERCION_7", "COERCION_8", "COERCION_9", "COERCION_10", "CON_GAME_1", "CON_GAME_2", "CON_GAME_3", "CON_GAME_4", "CON_GAME_5", "CON_GAME_6", "DEFAMATION_1", "DEFAMATION_2", "DEFAMATION_3", "DEFAMATION_4", "METHOD_C", "EXECUTION_1", "EXECUTION_2", "EXECUTION_3", "EXECUTION_4", "EXECUTION_5", "EXECUTION_6", "EXECUTION_7", "EXECUTION_8", "METHOD_D", "METHOD_E", "MAGIC_MAYHEM_1", "MAGIC_MAYHEM_2", "MAGIC_MAYHEM_3", "MAGIC_MAYHEM_4", "MAGIC_MAYHEM_5", "MAGIC_MAYHEM_6", "MAGIC_MAYHEM_7", "MAGIC_MAYHEM_8", "MURDER_1", "MURDER_2", "MURDER_3", "MURDER_4", "MURDER_5", "MURDER_6", "MURDER_7", "MURDER_8", "MURDER_9", "MURDER_10", "METHOD_F", "POLITICS_1", "POLITICS_2", "POLITICS_3", "POLITICS_4", "POLITICS_5", "POLITICS_6", "RELIGION_1", "RELIGION_2", "RELIGION_3", "RELIGION_4", "METHOD_G", "THIEVERY_1", "THIEVERY_2", "THIEVERY_3", "THIEVERY_4", "THIEVERY_5", "THIEVERY_6", "THIEVERY_7", "THIEVERY_8", "THIEVERY_9", "THIEVERY_10", "TORTURE_1", "TORTURE_2", "TORTURE_3", "TORTURE_4", "TORTURE_5", "TORTURE_6", "VICE_1", "VICE_2", "VICE_3", "VICE_4", "WARFARE_1", "WARFARE_2", "WARFARE_3", "WARFARE_4", "WARFARE_5", "WARFARE_6" };
	// "METHOD_A", "METHOD_B", "METHOD_C", "METHOD_D", "METHOD_E", "METHOD_F", "METHOD_G"
	private static final String[] DEVASTATION_ONLY = { "DEVASTATION_1", "DEVASTATION_2", "DEVASTATION_3", "DEVASTATION_4" };
	private static final String[] COERCION_ONLY = { "COERCION_1", "COERCION_2", "COERCION_3", "COERCION_4", "COERCION_5", "COERCION_6", "COERCION_7", "COERCION_8", "COERCION_9", "COERCION_10" };
	private static final String[] CON_GAME_ONLY = { "CON_GAME_1", "CON_GAME_2", "CON_GAME_3", "CON_GAME_4", "CON_GAME_5", "CON_GAME_6" };
	private static final String[] DEFAMATION_ONLY = { "DEFAMATION_1", "DEFAMATION_2", "DEFAMATION_3", "DEFAMATION_4" };
	private static final String[] EXECUTION_ONLY = { "EXECUTION_1", "EXECUTION_2", "EXECUTION_3", "EXECUTION_4", "EXECUTION_5", "EXECUTION_6", "EXECUTION_7", "EXECUTION_8" };
	private static final String[] MAGIC_MAYHEM_ONLY = { "MAGIC_MAYHEM_1", "MAGIC_MAYHEM_2", "MAGIC_MAYHEM_3", "MAGIC_MAYHEM_4", "MAGIC_MAYHEM_5", "MAGIC_MAYHEM_6", "MAGIC_MAYHEM_7", "MAGIC_MAYHEM_8" };
	private static final String[] MURDER_ONLY = { "MURDER_1", "MURDER_2", "MURDER_3", "MURDER_4", "MURDER_5", "MURDER_6", "MURDER_7", "MURDER_8", "MURDER_9", "MURDER_10" };
	private static final String[] POLITICS_ONLY = { "POLITICS_1", "POLITICS_2", "POLITICS_3", "POLITICS_4", "POLITICS_5", "POLITICS_6" };
	private static final String[] RELIGION_ONLY = { "RELIGION_1", "RELIGION_2", "RELIGION_3", "RELIGION_4" };
	private static final String[] THIEVERY_ONLY = { "THIEVERY_1", "THIEVERY_2", "THIEVERY_3", "THIEVERY_4", "THIEVERY_5", "THIEVERY_6", "THIEVERY_7", "THIEVERY_8", "THIEVERY_9", "THIEVERY_10" };
	private static final String[] TORTURE_ONLY = { "TORTURE_1", "TORTURE_2", "TORTURE_3", "TORTURE_4", "TORTURE_5", "TORTURE_6" };
	private static final String[] VICE_ONLY = { "VICE_1", "VICE_2", "VICE_3", "VICE_4" };
	private static final String[] WARFARE_ONLY = { "WARFARE_1", "WARFARE_2", "WARFARE_3", "WARFARE_4", "WARFARE_5", "WARFARE_6" };
	...
	public static String randomMeans() {
		// TODO - additional selection methods
		String[] array, generics = { "METHOD_A", "METHOD_B", "METHOD_C", "METHOD_D", "METHOD_E", "METHOD_F", "METHOD_G" };
