...
public enum Tool implements Item, Proficiency {
	ALCHEMIST, BREWER, CALLIGRAPHER, CARPENTER, CARTOGRAPHER, COBBLER, COOK, GLASSBLOWER, JEWELER, LEATHERWORKER, MASON, NAVIGATOR, PAINTER, POTTER, SMITH, TINKER, WEAVER, WOODCARVER, DISGUISE_KIT, FORGERY_KIT, CHESS_SET, GAMING_DICE, PLAYING_CARDS, HERBALISM_KIT, BAGPIPES, DRUM, DULCIMER, FLUTE, LUTE, LYRE, HORN, PAN_FLUTE, SHAWM, VIOL, POISONER_KIT, THIEVES_TOOLS, CARRIAGE, CART, CHARIOT, SLED, WAGON, GALLEY, KEELBOAT, LONGSHIP, ROWBOAT, SAILING_SHIP, WARSHIP;
