...
public abstract class Immortal {
	...
	private static final Lesser[] PANTHEONS = {
			// FIXME - need minimum 20 entities (try adding Zeus's lovers, etc)
			// Lesser.TITAN, Lesser.OLYMPIAN, Lesser.OCEANIC, Lesser.CHTHONIAN,
			// Lesser.ELOHIM,
			Lesser.ANGEL, Lesser.DEMON, Lesser.ELEMENTAL, Lesser.NYMPH, Lesser.CYCLOPS, Lesser.JOTUNN, Lesser.WITCH,
			Lesser.CENTAUR, Lesser.SIDHE };
