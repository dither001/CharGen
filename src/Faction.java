...
public interface Faction {
	public enum Tag {
		COLONISTS, DEEP_ROOTED, EUGENICS_CULT, EXCHANGE_CONSULATE, FANATICAL, IMPERIALISTS, MACHIAVELLIAN, MERCENARY_GROUP, PERIMETER_AGENCY, PIRATES, PLANETARY_GOVERNMENT, PLUTOCRATIC, PRECEPTOR_ARCHIVE, PSYCHIC_ACADEMY, SAVAGE, SCAVENGERS, SECRETIVE, TECHNICAL_EXPERTISE, THEOCRATIC, WARLIKE
	}
	 ...
	 * STATIC FIELDS
	 */
	public static final Tag[] TAGS = { Tag.COLONISTS, Tag.DEEP_ROOTED, Tag.EUGENICS_CULT, Tag.EXCHANGE_CONSULATE,
			Tag.FANATICAL, Tag.IMPERIALISTS, Tag.MACHIAVELLIAN, Tag.MERCENARY_GROUP, Tag.PERIMETER_AGENCY, Tag.PIRATES,
			Tag.PLUTOCRATIC, Tag.PRECEPTOR_ARCHIVE, Tag.PSYCHIC_ACADEMY, Tag.SAVAGE, Tag.SCAVENGERS, Tag.SECRETIVE,
			Tag.TECHNICAL_EXPERTISE, Tag.THEOCRATIC, Tag.WARLIKE };
